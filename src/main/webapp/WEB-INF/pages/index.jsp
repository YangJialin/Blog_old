...
<nav class="navbar navbar-expand-md navbar-dark bg-primary">
    <div class="container">
        <a class="navbar-brand" href="#"><i class="fa d-inline fa-lg fa-cloud"></i><b>Blog</b></a>
        ...
        <div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="#"><i class="fa d-inline fa-lg fa-bookmark-o"></i>全部文章</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"><i class="fa d-inline fa-lg fa-envelope-o"></i></a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="container-fluid px-5 h-100 w-75">
    <div class="row w-100 px-4 h-100">
        ...
        <div class="col-md-3 mx-4">
            ...
            <ul class="list-group">
                <li class="list-group-item"><i class="fa fa-home fa-fw"></i>最近更新</li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="p-4 col-md-7">
                    ...
                    <p>"<i>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</i>" &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp;&nbsp;
                        <br></p>
                </div>
            </div>
