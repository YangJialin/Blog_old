...
<html><head>
    ...
    <link rel="stylesheet" href="theme.css" type="text/css"> </head><body>
<div class="py-5 text-center opaque-overlay w-100 h-100" style="background-image: url(&quot;https://pingendo.github.io/templates/sections/assets/cover_event.jpg&quot;);">
    <div class="container py-5">
        <div class="row">
            <div class="col-md-12 text-white">
                <h1 class="display-3 mb-4">Gallin's Blog</h1>
                ...
                <a href="#menu" class="btn btn-lg mx-1 btn-secondary" data-toggle="">访问博客</a>
                <a href="#" class="btn btn-lg btn-primary mx-1">博主简历</a>
            </div>
        </div>
    </div>
</div>
<nav id="menu" class="navbar navbar-expand-md bg-secondary navbar-dark">
    <div class="container">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 mt-3">
                <p class="text-center text-white">© Copyright 2017 <a href="WEB-INF/pages/login.jsp">Gallin</a> - All rights reserved. </p>
            </div>
        </div>
    </div>
</div>
